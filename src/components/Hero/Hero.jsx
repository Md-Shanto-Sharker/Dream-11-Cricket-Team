        ...
        <div className='bg-[url(/public/photos/bg-shadow.png)] bg-no-repeat bg-gray-950 bg-cover bg-center  p-32 mx-auto mt-10 rounded-3xl'>
           <div className='flex justify-center mb-8'>
            ...
            <div className='text-center mt-10'>
                <button onClick={()=>handleClicked()} className='btn bg-[#E7FE29] btn-outline border-4 border-black rounded-xl outline-1 outline-[#E7FE29] font-bold '>Claim Free Credit</button>
            </div>
        </div>
    );
};
